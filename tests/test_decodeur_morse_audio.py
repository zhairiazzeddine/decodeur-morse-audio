...
from decodeur_morse_audio import __version__
from decodeur_morse_audio.__main__ import main, _parse_args
...
def test_main(mocker, tmp_path: Path, capsys):
    ...
    mocker.patch("decodeur_morse_audio.__main__.MorseCode", TestClass)
